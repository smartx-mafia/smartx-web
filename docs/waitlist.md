...
> 2026-09-09 更新：本文历史版本中的强制社群解锁、点击即完成分享、有限邀请码及邮箱验证即计入有效邀请等规则已被替换。当前规则及前后端交接以 [分享验证交接](./waitlist-share-verification.md) 和 [当前流程](./waitlist-flow.md) 为准；题目及人格配置未在本次调整。
